...
const de: Catalog = {
  ...
  "about.language.hint":
    "Die Oberfläche von Kavka — Seitenleiste, Befehlspalette, diese Dialoge und das Verbindungsformular. Die Cluster-Ansichten sind noch englisch; sie werden als Nächstes übersetzt.",
